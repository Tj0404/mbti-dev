...
export const results = [
  {
    ...
    results: [
      '혼자서 멘탈 케어가 가능해요!<br>소속이 없어도, 벌이가 불안정해도<br>저는 지금이 좋아요!',
      '일에 대한 욕심이 많아요.<br>행복한 야근이라고 할 수 있어요!',
      '자유로운 환경에서 더 잘해요!<br>하지만 누구보다 스스로 시간 관리가<br>철저해요:)',
  ...
  },
  {
    ...
    results: [
      '나는야 회사 사람들 멘탈 지킴이!<br>언제나 토닥토닥 으샤으샤 응원하며 다니는<br>파워 인싸!',
      '여러 사람과 협업이 필요한 직무에 찰떡!',
      '진행력 갑! 추진력 갑!<br>빠른 속도로 동시에 여러 업무를<br>해결할 수 있어요.',
  ...
  },
  {
    ...
    results: [
      ...
      '섬세함이 장점으로<br>업무를 센스 있게 처리한다는 말을<br>자주 들어요.',
  ...
  },
  {
    ...
    results: [
      ...
      '평소 경제와 사회 이슈에<br>관심이 매우 많아요.',
      '꿈이 커요!<br>크게 성공할 수 있는 한 방을<br>이뤄낼 거예요~',
  ...
  },
  {
    ...
    results: [
      ...
      '(이상) <<<<<< (현실)<br>가끔 이성에게 상처를 줄 때가<br>있어요, 그게 아닌데...'
    ],
    jobs: ['개발자', '데이터분석가'],
